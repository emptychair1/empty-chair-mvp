...
resilient SMS transport, timezone-safe appointment formatting, delivery-aware recovery,
social auth, safe phone signup boundary, multi-source client import, and phone/PWA
surface. Legacy 1.x modules remain in the repository for history/rollback and are never
