...
resilient SMS transport, timezone-safe appointment formatting, social auth, safe phone
signup boundary, multi-source client import, and phone/PWA surface. Legacy 1.x modules
remain in the repository for history/rollback and are never imported in production.
"""
