...
resilient SMS transport, social auth, safe phone signup boundary, and phone/PWA surface.
Legacy 1.x modules remain in the repository for history/rollback and are never imported
in production.
"""
