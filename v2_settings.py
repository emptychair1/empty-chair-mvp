...
<div class="settings-list">
  ...
  <a class="settings-row" href="/settings/subscription"><span>SUBSCRIPTION<small>plan + billing</small></span><span>›</span></a>
...
def settings_subscription(request: Request):
    ...
    return core.page("Subscription", f'''
<h1>SUBSCRIPTION</h1>
<p class="dim">Keep Empty Chair armed. Choose the billing cadence that fits you.</p>
<div class="stack">
  <div class="error"><p>MONTHLY</p><p class="big">{_price(MONTHLY_PRICE, 'PRICE NOT SET')}</p><p class="dim">cancel anytime</p>{_subscription_button('CHOOSE MONTHLY', MONTHLY_URL)}</div>
  <div class="error"><p>YEARLY</p><p class="big">{_price(YEARLY_PRICE, 'PRICE NOT SET')}</p><p class="dim">one annual payment</p>{_subscription_button('CHOOSE YEARLY', YEARLY_URL)}</div>
  {manage}
  <a class="button quiet" href="/settings">BACK</a>
</div>''')
